...
bool test1_1() {
	wstring line;
	const wstring lines[3] = {L"Розробник: Гончарук Олександр", L"Установа/організація: Центральноукраїнський національний технічний університет", L"Рік розробки: 2023"};
...
int main() {
	const wstring data1_1[] = {L"Університет", L"Університету", L"Україна", L"України"};
	const bool wordPresent[] = {true, false, true, false};

	const wstring data2_1[] = {L"Блокнот", L"0123456789", L"12", L"00000"};
